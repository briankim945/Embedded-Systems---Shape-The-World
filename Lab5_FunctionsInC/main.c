...
// Put your Lab 5 code here
	if ((l >= 3) && (l <= 20) && (w >= 3) && (w <= 20)) { // Verify that length and width are between 3 and 20, inclusive
		result = l * w; // area is length * width
	} else {
		result = 0;     // area is zero if l and w are out of bounds
	}
